        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (response.status === 200) {
              ...
              document.cookie = "jwt=".concat(token, " ; expires=Sun, 1 Jan 2023 00:00:00 UTC; path=/");
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', 'logged in failure');
...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (item) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(item.coordinates).setHTML("<p>Day ".concat(item.day, ": ").concat(item.description, "</p>")).addTo(map);
...
if (document.querySelector('.nav__el--logout')) {
  var btn = document.querySelector('.nav__el--logout');
